...
public final class Polygon {
    ...
    public static Polygon generateUV(
            Polygon polygon,
            TessellatorQuadTemplate template) {//TODO: update?
        ...
        List<ClipVertex> vertices =
                new ArrayList<>(polygon.getVertices().size());

        for (ClipVertex source : polygon.getVertices()) {
            ClipVertex vertex = source.copy();
